		...
		foreach($products as $product){
			echo "<div class='product'>";
				echo "<a>";
					...
					echo "</div>";
					echo "<span class='number'><input type='button' class='submit' value='Izbriši' onClick='delete_product(".$product->product_id.");' style='margin-left:20px;margin-top:10px;'/></span>";
				echo "</a>";
			echo "</div>";
		}
	}else{
